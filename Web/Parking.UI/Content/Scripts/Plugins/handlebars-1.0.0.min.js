...
(function(){Handlebars.AST={};Handlebars.AST.ProgramNode=function(b,a){this.type="program";this.statements=b;a&&(this.inverse=new Handlebars.AST.ProgramNode(a))};Handlebars.AST.MustacheNode=function(b,a,c){this.type="mustache";this.id=b[0];this.params=b.slice(1);this.hash=a;this.escaped=!c};Handlebars.AST.PartialNode=function(b,a){this.type="partial";this.id=b;this.context=a};var c=function(b,a){if(b.original!==a.original)throw new Handlebars.Exception(b.original+" doesn't match "+a.original);};Handlebars.AST.BlockNode=
function(b,a,f){c(b.id,f);this.type="block";this.mustache=b;this.program=a};Handlebars.AST.InverseNode=function(b,a,f){c(b.id,f);this.type="inverse";this.mustache=b;this.program=a};Handlebars.AST.ContentNode=function(b){this.type="content";this.string=b};Handlebars.AST.HashNode=function(b){this.type="hash";this.pairs=b};Handlebars.AST.IdNode=function(b){this.type="ID";this.original=b.join(".");for(var a=[],c=0,g=0,e=b.length;g<e;g++){var i=b[g];".."===i?c++:"."===i||"this"===i?this.isScoped=!0:a.push(i)}this.parts=
a;this.string=a.join(".");this.depth=c;this.isSimple=1===a.length&&0===c};Handlebars.AST.StringNode=function(b){this.type="STRING";this.string=b};Handlebars.AST.IntegerNode=function(b){this.type="INTEGER";this.integer=b};Handlebars.AST.BooleanNode=function(b){this.type="BOOLEAN";this.bool=b};Handlebars.AST.CommentNode=function(b){this.type="comment";this.comment=b}})();
...
{};for(var a in c.OPCODE_MAP)c.DISASSEMBLE_MAP[c.OPCODE_MAP[a]]=a;c.multiParamSize=function(i){return c.MULTI_PARAM_OPCODES[c.DISASSEMBLE_MAP[i]]};c.prototype={compiler:c,disassemble:function(){for(var i=this.opcodes,a,b=[],e,f=0,h=i.length;f<h;f++)if(a=i[f],"DECLARE"===a)e=i[++f],a=i[++f],b.push("DECLARE "+e+" = "+a);else{e=c.DISASSEMBLE_MAP[a];for(var g=c.multiParamSize(a),k=[],j=0;j<g;j++)a=i[++f],"string"===typeof a&&(a='"'+a.replace("\n","\\n")+'"'),k.push(a);e=e+" "+k.join(" ");b.push(e)}return b.join("\n")},
guid:0,compile:function(a,d){this.children=[];this.depths={list:[]};this.options=d;var b=this.options.knownHelpers;this.options.knownHelpers={helperMissing:!0,blockHelperMissing:!0,each:!0,"if":!0,unless:!0,"with":!0,log:!0};if(b)for(var c in b)this.options.knownHelpers[c]=b[c];return this.program(a)},accept:function(a){return this[a.type](a)},program:function(a){var a=a.statements,d;this.opcodes=[];for(var b=0,c=a.length;b<c;b++)d=a[b],this[d.type](d);this.isSimple=1===c;this.depths.list=this.depths.list.sort(function(a,
i){return a-i});return this},compileProgram:function(a){var a=(new this.compiler).compile(a,this.options),d=this.guid++;this.usePartial=this.usePartial||a.usePartial;this.children[d]=a;for(var b=0,c=a.depths.list.length;b<c;b++)depth=a.depths.list[b],2>depth||this.addDepth(depth-1);return d},block:function(a){var d=a.mustache,b=this.setupStackForMustache(d),c=this.compileProgram(a.program);a.program.inverse&&(a=this.compileProgram(a.program.inverse),this.declare("inverse",a));this.opcode("invokeProgram",
c,b.length,!!d.hash);this.declare("inverse",null);this.opcode("append")},inverse:function(a){var d=this.setupStackForMustache(a.mustache);this.declare("inverse",this.compileProgram(a.program));this.opcode("invokeProgram",null,d.length,!!a.mustache.hash);this.declare("inverse",null);this.opcode("append")},hash:function(a){var a=a.pairs,d,b;this.opcode("push","{}");for(var c=0,e=a.length;c<e;c++)d=a[c],b=d[1],this.accept(b),this.opcode("assignToHash",d[0])},partial:function(a){var d=a.id;this.usePartial=
...
void 0!==d&&this.opcodes.push(d);void 0!==b&&this.opcodes.push(b);void 0!==e&&this.opcodes.push(e)},declare:function(a,d){this.opcodes.push("DECLARE");this.opcodes.push(a);this.opcodes.push(d)},addDepth:function(a){0!==a&&!this.depths[a]&&(this.depths[a]=!0,this.depths.list.push(a))},setupStackForMustache:function(a){var d=a.params;this.pushParams(d);a.hash&&this.hash(a.hash);this.ID(a.id);return d}};b.prototype={nameLookup:function(a,d){return/^[0-9]+$/.test(d)?a+"["+d+"]":b.isValidJavaScriptVariableName(d)?
...
e;this.i++)a=this.nextOpcode(0),"DECLARE"===a[0]?(this.i+=2,this[a[1]]=a[2]):(this.i+=a[1].length,this[a[0]].apply(this,a[1]));return this.createFunctionContext(c)},nextOpcode:function(a){var d=this.environment.opcodes,b=d[this.i+a],e,f;if("DECLARE"===b)return e=d[this.i+1],a=d[this.i+2],["DECLARE",e,a];e=c.DISASSEMBLE_MAP[b];b=c.multiParamSize(b);f=[];for(var h=0;h<b;h++)f.push(d[this.i+h+1+a]);return[e,f]},eat:function(a){this.i+=a.length},preamble:function(){var a=[];this.useRegister("foundHelper");
if(this.isChild)a.push("");else{var b=this.namespace,c="helpers = helpers || "+b+".helpers;";this.environment.usePartial&&(c=c+" partials = partials || "+b+".partials;");a.push(c)}this.environment.isSimple?a.push(""):a.push(", buffer = "+this.initializeBuffer());this.lastContext=0;this.source=a},createFunctionContext:function(a){var b=this.stackVars;this.isChild||(b=b.concat(this.context.registers.list));0<b.length&&(this.source[1]=this.source[1]+", "+b.join(", "));if(!this.isChild)for(var c in this.context.aliases)this.source[1]=
...
pushString:function(a){this.pushStack(this.quotedString(a))},push:function(a){this.pushStack(a)},invokeMustache:function(a,b,c){this.populateParams(a,this.quotedString(b),"{}",null,c,function(a,b,c){this.usingKnownHelper||(this.context.aliases.helperMissing="helpers.helperMissing",this.context.aliases.undef="void 0",this.source.push("else if("+c+"=== undef) { "+a+" = helperMissing.call("+b+"); }"),a!==c&&this.source.push("else { "+a+" = "+c+"; }"))})},invokeProgram:function(a,b,c){var e=this.programExpression(this.inverse),
a=this.programExpression(a);this.populateParams(b,null,a,e,c,function(a,b){this.usingKnownHelper||(this.context.aliases.blockHelperMissing="helpers.blockHelperMissing",this.source.push("else { "+a+" = blockHelperMissing.call("+b+"); }"))})},populateParams:function(a,b,c,e,f,h){var g=f||this.options.stringParams||e||this.options.data,k=this.popStack(),j=[],m;g?(this.register("tmp1",c),m="tmp1"):m="{ hash: {} }";g&&this.source.push("tmp1.hash = "+(f?this.popStack():"{}")+";");this.options.stringParams&&
this.source.push("tmp1.contexts = [];");for(g=0;g<a;g++)f=this.popStack(),j.push(f),this.options.stringParams&&this.source.push("tmp1.contexts.push("+this.popStack()+");");e&&(this.source.push("tmp1.fn = tmp1;"),this.source.push("tmp1.inverse = "+e+";"));this.options.data&&this.source.push("tmp1.data = data;");j.push(m);this.populateCall(j,k,b||k,h,"{}"!==c)},populateCall:function(a,b,c,e,f){var g=["depth0"].concat(a).join(", "),a=["depth0"].concat(c).concat(a).join(", "),c=this.nextStack();this.usingKnownHelper?
this.source.push(c+" = "+b+".call("+g+");"):(this.context.aliases.functionType='"function"',this.source.push("if("+(f?"foundHelper && ":"")+"typeof "+b+" === functionType) { "+c+" = "+b+".call("+g+"); }"));e.call(this,c,a,b);this.usingKnownHelper=!1},invokePartial:function(a){params=[this.nameLookup("partials",a,"partial"),"'"+a+"'",this.popStack(),"helpers","partials"];this.options.data&&params.push("data");this.pushStack("self.invokePartial("+params.join(", ")+");")},assignToHash:function(a){var b=
this.popStack();this.source.push(this.topStack()+"['"+a+"'] = "+b+";")},compiler:b,compileChildren:function(a,b){for(var c=a.children,e,f,g=0,n=c.length;g<n;g++){e=c[g];f=new this.compiler;this.context.programs.push("");var k=this.context.programs.length;e.index=k;e.name="program"+k;this.context.programs[k]=f.compile(e,b,this.context)}},programExpression:function(a){if(null==a)return"self.noop";for(var b=this.environment.children[a],a=b.depths.list,b=[b.index,b.name,"data"],c=0,e=a.length;c<e;c++)depth=
...
this.stackSlot>this.stackVars.length&&this.stackVars.push("stack"+this.stackSlot);return"stack"+this.stackSlot},popStack:function(){return"stack"+this.stackSlot--},topStack:function(){return"stack"+this.stackSlot},quotedString:function(a){return'"'+a.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n").replace(/\r/g,"\\r")+'"'}};a="break,else,new,var,case,finally,return,void,catch,for,switch,while,continue,function,this,with,default,if,throw,delete,in,try,do,instanceof,typeof,abstract,enum,int,short,boolean,export,interface,static,byte,extends,long,super,char,final,native,synchronized,class,float,package,throws,const,goto,private,transient,debugger,implements,protected,volatile,double,import,public,let,yield".split(",");
for(var f=b.RESERVED_WORDS={},g=0,e=a.length;g<e;g++)f[a[g]]=!0;b.isValidJavaScriptVariableName=function(a){return!b.RESERVED_WORDS[a]&&/^[a-zA-Z_$][0-9a-zA-Z_$]+$/.test(a)?!0:!1}})(Handlebars.Compiler,Handlebars.JavaScriptCompiler);Handlebars.precompile=function(c,b){var b=b||{},a=Handlebars.parse(c),a=(new Handlebars.Compiler).compile(a,b);return(new Handlebars.JavaScriptCompiler).compile(a,b)};
Handlebars.compile=function(c,b){var b=b||{},a;return function(f,g){if(!a){var e=Handlebars.parse(c),e=(new Handlebars.Compiler).compile(e,b),e=(new Handlebars.JavaScriptCompiler).compile(e,b,void 0,!0);a=Handlebars.template(e)}return a.call(this,f,g)}};
...
2);return function(a,e){e=e||{};return c.apply(this,[a,e.data||b].concat(f))}},program:function(c,b){return function(a,f){f=f||{};return c(a,f.data||b)}},noop:function(){return""},invokePartial:function(c,b,a,f,g,e){options={helpers:f,partials:g,data:e};if(void 0===c)throw new Handlebars.Exception("The partial "+b+" could not be found");if(c instanceof Function)return c(a,options);if(Handlebars.compile)return g[b]=Handlebars.compile(c),g[b](a,options);throw new Handlebars.Exception("The partial "+
